#!/usr/bin/env python3
"""
Train the CNN model with the actual cattle breed dataset
"""
...
def create_improved_model(num_classes):
    """Create an improved CNN model for better accuracy"""
...
def train_model_with_augmentation(X, y, breed_names):
...
def main():
    ...
    print("=" * 60)
    print("Training Cattle Breed Classification Model")
    print("=" * 60)
    ...
    # Create model
    model = create_improved_model(num_classes=len(breed_names))
    
    # Train model
    history = train_model_with_augmentation(X, y, breed_names)
